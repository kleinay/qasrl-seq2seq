...
#                 test_dataset = "qanom",
#                 output_dir=None, 
#                 wandb_run_name=f"{now()} Evaluate qanom joint  ",
#                 do_eval_on_dev=True,
...
load_and_evaluate(model_dir,
                test_dataset = "qanom",
                output_dir=None, 
                wandb_run_name=f"{now()} Evaluate qanom joint (qanom protocol)",
                do_eval_on_dev=True,
                evaluation_protocol="qanom",
                constrain_generation=False,
                # limit_eval_data=0.05,
...
load_and_evaluate(model_dir,
                test_dataset = "qasrl",
                output_dir=None, 
                wandb_run_name=f"{now()} Evaluate qasrl joint (qanom protocol)",
                do_eval_on_dev=True,
                evaluation_protocol="qanom",
                constrain_generation=False,
                # limit_eval_data=0.05,
...
load_and_evaluate(model_dir,
                test_dataset = "qasrl",
                output_dir=None, 
                wandb_run_name=f"{now()} Evaluate qasrl joint (qasrl protocol)",
                do_eval_on_dev=True,
